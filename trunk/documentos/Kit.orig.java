...
public class Kit {
	...
	/* Coloca a Vcc os bits indicados pela mascara e os restantes bits mantêm o valor. */  
	public static void setBits(int mask) { ... }
	
	/* Coloca a GND os bits indicados pela mascara e os restantes bits mantêm o valor. */  
	public static void resetBits(int mask) { ... }
	
	/* Inverte o valor dos bits indicados pela mascara e os restantes bits mantêm o valor. */  
